...
> affiliated with, endorsed by, or supported by the Cysharp organization**.
>
> - The wrapper author has **no affiliation** with the Cysharp organization
...
- **Package Name**: `com.klumhru.wrapper.unitask`
- **Version**: 2.5.10-1
- **Namespace**: `Cysharp.Threading.Tasks`
- **Original Source**: https://github.com/Cysharp/UniTask.git
